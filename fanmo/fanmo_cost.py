...
# 유효 구간은 그 스냅샷이 실제로 적용됐던 반월 주기 하나뿐이다. fanmo260715_copy.csv는
# 2026-07-15에 캡쳐한 것으로, 그날부터 시작하는 주기인 2026-07-15~07-31에 적용됐다
# (7/15는 갱신일이 아니라 그 앞 주기 막바지에 캡쳐한 것 — 실제 갱신은 7/16이 아니라
# 7/15부터였다고 확인됨). 그 앞(2026년 1월~7월14일)과 뒤(다음 스냅샷이 나오기 전인
# 8/1~8/15 공백)는 우리가 실제로 캡쳐한 적 없는 구간이라 마찬가지로 공란(None) 처리한다
# — 지난 스냅샷을 그 공백에 갖다 쓰면 조용히 틀린 코스트가 박히기 때문이다.
