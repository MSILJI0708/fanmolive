...
# 유효 구간은 그 스냅샷을 실제로 캡쳐한 반월 주기 하나뿐이다. fanmo260715_copy.csv는
# 2026-07-15에 캡쳐한 것이니 유효 구간은 2026-07-01~07-15 그 주기뿐이고(2026-07-16
# 이후는 다음 주기라 코스트가 이미 갈렸을 수 있다), 그 앞뒤로 우리가 실제로 캡쳐하지
# 않은 구간(2026년 1~6월, 그리고 다음 스냅샷이 나오기 전인 7/16~8/15)은 전부 조사한
# 적이 없는 공백이다 — 지난 스냅샷을 그 공백에 갖다 쓰면 조용히 틀린 코스트가 박히므로
# 공란(None)으로 둔다.
